...
function main(argv) {
  ...
  // On Windows the binaries in `node_modules/.bin` are `.CMD` shims, and
  // `spawn` cannot execute those without a shell — without this the launcher
  // dies with ENOENT before Vite ever starts.
